...
namespace Exemplo_3_Endpoint_ASPNET_Banco
{
    public class Executar
    {
        public static void Main(string[] args)
        {
            ...
            var connectionString = builder.Configuration.GetConnectionString("PostgresConnection"); // Pega a string de conexão do arquivo appsettings.json

            // Registar o AppDbContext com Postgres
            builder.Services.AddDbContext<AppDbContext>(options => options.UseNpgsql(connectionString)); // Adiciona o serviço de banco de dados
